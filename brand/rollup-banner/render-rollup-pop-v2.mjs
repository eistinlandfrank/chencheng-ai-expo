...
<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="${width}" height="${height}" viewBox="0 0 ${width} ${height}">
  ...
  <text x="1925" y="1325" fill="#FF4D2E" font-family="Arial, sans-serif" font-size="350" font-weight="950">?</text>
  ...
  <g transform="translate(110 4825)">
    ...
    <text x="0" y="755" fill="#A9C0B6" font-family="Microsoft YaHei, sans-serif" font-size="42" font-weight="650">无需注册｜观展记录仅存本机</text>
  </g>
  ...
  <text x="110" y="5855" fill="#708B7F" font-family="Microsoft YaHei, sans-serif" font-size="31" font-weight="500">当前为黑客松演示数据；地图与路线经场馆复核后开放。</text>
